    ...
    const getMockResults = (problemType) => {
      const results = {
        다항식: {
          ...
          해설: "[풀이]\n(1) 5x² - x + 3\n(2) x² - x - 6\n(3) 4x² + 4x + 1\n\n동류항끼리 모아서 정리하고, 곱셈은 분배법칙을 이용합니다."
        },
        이차방정식: {
          ...
          해설: "[풀이]\n(1) x = 2, 3\n(2) x = -3, -1/2\n(3) x = ±2\n\n인수분해를 이용하여 각 인수를 0으로 만드는 x의 값을 구합니다."
        },
        함수: {
          ...
          해설: "[풀이]\n(1) 기울기 2, y절편 3\n(2) 꼭짓점 (2, -1)\n(3) 꼭짓점 (1, 2)\n\n일차함수는 기울기와 y절편, 이차함수는 꼭짓점과 축을 구합니다."
        },
        기하: {
          ...
          해설: "[풀이]\n(1) 25π cm² (약 78.5 cm²)\n(2) 24 cm²\n(3) 70 cm²\n\n각 도형의 넓이 공식을 이용합니다. 원: πr², 삼각형: (밑변×높이)÷2, 직사각형: 가로×세로"
        },
        확률: {
          ...
          해설: "[풀이]\n(1) 1/6\n(2) 1/4\n(3) 3/10\n\n확률 = (원하는 경우의 수) ÷ (전체 경우의 수) 공식을 이용합니다."
        }
      };
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 2fr 1fr', gap: '20px', marginBottom: '24px' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                ...
                <div style={cardStyle}>
                  ...
                  <textarea
                    value={aiResults[selectedProblem?.id]?.해설 || ''}
                    onChange={(e) => {
